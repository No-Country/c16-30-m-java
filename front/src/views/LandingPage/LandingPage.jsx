  ...
  return (
    <div className="bg-white w-96 p-3 shadow-2xl">
            ...
            <h1 className="text-3xl p-2 m-2 text-center">Bienvenid@</h1>
                ...
                <input id="email" type="text" value={username} onChange={handleUsernameChange} placeholder="Ej: tunombre@mail.com"/>
                <label htmlFor="pass">Contraseña</label>
                <input id="pass" type="password" value={password} onChange={handlePasswordChange} placeholder="********"/>
